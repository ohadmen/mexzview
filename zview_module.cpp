...
template <typename T>mxClassID getMXtype(){return mxUNKNOWN_CLASS;}
template <> mxClassID getMXtype<float>(){return mxSINGLE_CLASS;}
template <> mxClassID getMXtype<int32_t>(){return mxINT32_CLASS;}
template <> mxClassID getMXtype<uint32_t>(){return mxUINT32_CLASS;}
template <> mxClassID getMXtype<int64_t>(){return mxINT64_CLASS;}
template <> mxClassID getMXtype<uint64_t>(){return mxUINT64_CLASS;}
template <> mxClassID getMXtype<bool>(){return mxLOGICAL_CLASS;}
...
void func_addColoredPoints(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    auto [ptsdata,npts] = getMatrixFromMxarray<float,6>(prhs,3);
